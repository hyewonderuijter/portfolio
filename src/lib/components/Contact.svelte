...
main {
    background: url('https://pub-6e499fd5de234ef3aba9fca203ce8d62.r2.dev/static/footer-bg.svg') no-repeat bottom / cover;
    height: 40vh;
    display: flex;
...
.container {
    display: flex;
    flex-direction: row; /* Ensure items are stacked vertically */
