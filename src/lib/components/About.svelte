...
<main>
    ...
    <div data-aos="fade-up" data-aos-duration="1300">
        <div class="container">
            <div class="imgarea">
                <img src="https://pub-6e499fd5de234ef3aba9fca203ce8d62.r2.dev/static/aboutme.png" alt="profile in the about page" class="about-profile">
                    ...
                    {:else if activeTab === "qualification"}
                        <div data-state="active" class="active-qualification">
                            ...
                            <div class="qualification-list">
                                <div class="education">
                                    <div class="title">
                                        <img src="https://pub-6e499fd5de234ef3aba9fca203ce8d62.r2.dev/static/education-icon.png" alt="education" class="qualification-icon">
                                        <h3>Education</h3>
                                    </div>
                                ...
                                <div class="experience">
                                    <div class="title">
                                        <img src="https://pub-6e499fd5de234ef3aba9fca203ce8d62.r2.dev/static/work-icon.png" alt="work" class="qualification-icon">
                                        <h3>Experience</h3>
                                    </div>
                    ...
                    {:else if activeTab === "skills"}
                        <div data-state="active" class="active-skills">
                            ...
                            <div class="skill-list">
                                ...
                                <img width="48" height="48" src="https://pub-6e499fd5de234ef3aba9fca203ce8d62.r2.dev/static/svelte-icon.png" alt="svelte"/>
                            </div>
                        </div>
                    {/if}
                </div>
